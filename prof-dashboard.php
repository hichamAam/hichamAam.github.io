...
if( !empty($_COOKIE["usertype"]) && !empty($_COOKIE["username"])){
    ...
    if($usertype != "prof"){
        ...
        $sql = "SELECT * FROM prof JOIN userlogin ON prof.userprof = userlogin.username WHERE username='$username'";
        $result = mysqli_query($db_con,$sql);
        $profarray = mysqli_fetch_assoc($result);

        $prenom = $profarray["prenom"];
        $nom = $profarray["nom"];
        $notell = $profarray["Notell"];
